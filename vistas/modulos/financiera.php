    ...
    <div class="main-border-container" style="border: 1px solid #585858ff; padding-bottom: 10px;">
      ...
      <div class="footer-row px-3 mt-3">
        <div class="info-buttons">
          <button class="btn btn-sm btn-outline-success bg-success border-1" data-toggle="modal"
            data-target="#modalInfoAdicional">Informacion adicional</button>
          <button class="btn btn-sm btn-outline-success bg-success border-1" data-toggle="modal"
            data-target="#modalInfoBancaria">informacion bancaria</button>
        </div>
