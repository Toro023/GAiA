            ...
            <div class="container-fluid" style="padding: 20px;">
                ...
                <div class="container-header-financiera w-100">
                  <div class="seleccion-apoyos">
                    ...
                    <button class="btn btn-apoyo active" data-target="#tab-sostenimiento"><i class="fas fa-lock"></i> <span class="txt">Apoyo de<br>sostenimiento</span></button>
                    <button class="btn btn-apoyo" data-target="#tab-datos"><i class="fas fa-phone-alt"></i> <span class="txt">apoyo<br>de datos</span></button>
                    <button class="btn btn-apoyo" data-target="#tab-alimentacion"><i class="fas fa-utensils"></i> <span class="txt">apoyo de<br>alimentación</span></button>
                    <button class="btn btn-apoyo" data-target="#tab-transporte"><i class="fas fa-car-side"></i> <span class="txt">apoyo de<br>transporte</span></button>
                  </div>
                  
                  <div class="buscador-aprendiz">
                    <div class="search-wrapper-custom">
                      <i class="far fa-user search-icon"></i>
                      <input type="text" id="buscadorAprendiz" placeholder="Buscar aprendiz">
                    </div>
                  </div>
                </div>
                ...
                <div class="main-border-container" style="border: 1px solid #585858ff; padding-bottom: 10px;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="acciones-btns">
                                    <button class="btn-icon"><i class="far fa-file-alt"></i></button>
                                    <button class="btn-icon"><i class="far fa-eye"></i></button>
                                    <button class="btn-icon"><i class="fas fa-clipboard-list"></i></button>
                                </td>
                              </tr>
                              <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="footer-row px-3 mt-3">
                        <div class="info-buttons">
                            <button class="btn-info-bottom">Informacion adicional</button>
                            <button class="btn-info-bottom">informacion bancaria</button>
                            <button class="btn-info-bottom">descargar reportes</button>
                        </div>
                        <div id="paginacionCustom" class="paginacion-custom"></div>
                    </div>
                </div>
            </div>
            <!-- /.card -->    
